  ...
  const handleToggleActive = async (admin: UserDto) => {
    ...
    try {
      const response = newStatus
        ? await userService.updateUser(admin.userId, { isActive: true })
        : await userService.deactivateUser(admin.userId);
    ...
    <div className="space-y-4">
      ...
      <div>
        {loading ? (
          ...
          <div className="text-center py-12 text-muted-foreground flex flex-col items-center justify-center bg-white border rounded-md">
